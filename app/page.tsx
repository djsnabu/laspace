...
export default function Home() {
  return (
    <>
      ...
      {/* Past Events */}
      <section id="past-events" className="py-24 relative z-20 border-t border-white/5 bg-gradient-to-b from-transparent to-space-gray/20">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-4 text-gray-400">Menneet Klubit</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-neon-purple/40 to-neon-blue/40 mx-auto" />
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <EventList past />
          </div>
      ...
      <section id="instagram" className="py-24 relative z-20 border-t border-white/5 bg-gradient-to-b from-transparent to-space-gray/50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <a
              href="https://www.facebook.com/Laspaceevents"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-3 bg-[#1877F2] hover:bg-[#166FE5] text-white font-bold py-4 px-10 rounded-full hover:scale-105 transition-transform shadow-lg text-lg"
            >
              <FacebookIcon />
              Facebook
            </a>
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-3 bg-white text-black font-bold py-4 px-10 rounded-full hover:scale-105 transition-transform shadow-lg text-lg"
            >
              <TikTokIcon />
              TikTok
            </a>
